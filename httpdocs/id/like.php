<?php	
	...
	if (mysqli_num_rows($result) == 0) {
		$sql = "INSERT INTO tepkiler(begen, kullanici, haber_url, begenme) VALUES('1', '$user', '$haber_url', '0')";
		mysqli_set_charset($connection, "utf8");
		mysqli_query($connection, $sql);
	}else if (mysqli_num_rows($result) > 0) {
		$sql = "UPDATE tepkiler SET begen = '1', begenme = '0' WHERE haber_url LIKE '$haber_url' AND kullanici LIKE '$user'";
		mysqli_set_charset($connection, "utf8");
		mysqli_query($connection, $sql);
	}
