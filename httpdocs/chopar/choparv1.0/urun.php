        ...
        <div style="width:100%;height: auto;margin-top:30px;">
            <table style="width:60%;height: auto;margin:0 auto;">
                <?php
                    ...
                    $say = $row['total'];
                    for ($i = 1; $i <= 1; $i++) {
                        $sql = "SELECT * FROM urunler WHERE kod LIKE '$urun_kod'";
                        mysqli_set_charset($connection, "utf8");
                        $result = mysqli_query($connection, $sql);
                        $row = mysqli_fetch_assoc($result);
                        $kod = $row['kod'];
                    ...
                    <?php }
                    $sql = "SELECT COUNT(*) as total FROM yorumlar WHERE kod LIKE '$urun_kod'";
                    mysqli_set_charset($connection, "utf8");
                    $result = mysqli_query($connection, $sql);
                    $row = mysqli_fetch_assoc($result);
                    $adet = $row['total'];
            ...
            <table style="width:70%;margin:0 auto;">
                <tr>
                    <td style="width:auto;">
                        <p style="color:white;">Yorumlar (<?php echo $adet; ?>)</p>
                    </td>
                    <td style="width:100%;">
                        <div style="width:100%;height:2px;background-color:#FFD700;"></div>
                    </td>
                </tr>
            </table>
            <?php
            if($usr == session_id()){?>
                <form action="yorum.php" method="POST">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="text" name="kod" value="<?php echo $urun_kod; ?>" style="display:none;">
                                        </td>
                                    </tr>
                                </table>
                            </td>
                    ...
                    <table style="width:70%;margin:0 auto;">
                        <tr>
                            <td style="width:100%;">
                                <textarea type="text" id="yorum" name="yorum" rows="4" style="width:100%;" placeholder="Adres" required></textarea>
                            </td>
                        </tr>
                    </table>
                    <table style="width:70%;margin:0 auto;">
            ...
            <?php }else{
                $sql = "SELECT * FROM kullanici WHERE numara LIKE '$usr' OR mail LIKE '$usr'";
                mysqli_set_charset($connection, "utf8");
                $result = mysqli_query($connection, $sql);
                $row = mysqli_fetch_assoc($result);
                $ad = $row['ad'];
                ...
                <form action="yorum.php" method="POST">
                        ...
                        <tr>
                            <td style="width:auto;">
                                <table>
                                    <tr>
                                        <td>
                                            <input type="text" name="ad" placeholder="Ad" value="<?php echo $ad; ?>" style="display:none;">
                                        </td>
                                        <td>
                                            <input type="text" name="telefon" placeholder="Telefon" value="<?php echo $telefon; ?>" style="display:none;">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <input type="text" name="soyad" placeholder="Soyad" value="<?php echo $soyad; ?>" style="display:none;"
                                        </td>
                                        <td>
                                            <input type="text" name="mail" placeholder="Mail" value="<?php echo $mail; ?>" style="display:none;">
                                            <input type="text" name="kod" value="<?php echo $urun_kod; ?>" style="display:none;">
                                        </td>
                                    </tr>
                                </table>
                    ...
                    <table>
                        <tr>
                            <td style="width:100%;">
                                <textarea type="text" id="yorum" name="yorum" rows="4" cols="30" placeholder="Yorum" required></textarea>
                            </td>
                        </tr>
                    </table>
                    <table>
            ...
            <?php }
            $sql = "SELECT * FROM yorumlar WHERE kod LIKE '$urun_kod'";
            mysqli_set_charset($connection, "utf8");
            $result = mysqli_query($connection, $sql);
            if ($result->num_rows > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    $tarih = $row['tarih'];
                    ?>
                    <table style="background-color:#3A3A3A;width:80%;margin:0 left;text-align:left;">
                        <tr style="margin:left;">
                            <td style="margin:left;width:100%;">
                                <p style="color:#FFF"><?php echo $yorum; ?></p>
                            </td>
                            <td>
                            </td>
                        </tr>
                    ...
                    <table style="background-color:#3A3A3A;width:80%;margin:0 left;text-align:left;">
                        <tr style="margin:left;">
                            <td style="margin:left;">
                                <p style="color:#FFF"><?php echo "$ad $soyad"; ?></p>
                            </td>
                            <td style="margin:left;">
                                <p style="color:#FFF"><?php echo $tarih; ?></p>
                            </td>
                        </tr>
                    </table>
                    <table>
                        <tr style="width:100%;height:20px;background-color:black;">
                        <td>
                        </td>
                        </tr>
                    </table>
    ...
    <div style="width:100%;height: auto;margin-top:30px;">
                    ...
                    $fiyat_eski = $row['fiyat_eski'];?>
                        <tr style="width: 100%;height: 400px;margin: 0 auto;padding:10px;">
                            ...
                            <td style="width: 40%;height: 400px;margin: 0 auto;">
                                <img id="resim<?php echo $i; ?>" onClick="degis('resim<?php echo $i; ?>','<?php echo $kod; ?>')" src="<?php echo $kod; ?>_1.png" style="width: 100%;height: 100%;max-height:400px;">
                            </td>
            ...
            <form action="yorum.php" method="POST">
                <table style="width:70%;margin:0 auto;">
                    <tr>
                        ...
                        <td style="width:100%;">
                            <textarea type="text" id="yorum" name="yorum" rows="4" cols="30" placeholder="Yorum" required style="width:90%;"></textarea>
                        </td>
                        <td style="width:auto;">
                            <input type="submit" value="Paylaş">
                        </td>
            ...
            <form action="yorum.php" method="POST">
                <table style="width:70%;margin:0 auto;">
                    <tr>
                        ...
                        <td style="width:100%;">
                            <textarea type="text" id="yorum" name="yorum" rows="4" placeholder="Yorum" required style="width:90%;"></textarea>
                        </td>
                        <td style="width:auto;">
                            <input type="submit" value="Paylaş">
                        </td>
        ...
        if ($result->num_rows > 0) {
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                $tarih = $row['tarih'];
                ?>
                <table style="background-color:#3A3A3A;width:60%;margin:0 auto;">
                    <tr style="margin:left;">
                        <td style="margin:left;width:100%;">
                            <p style="color:#FFF"><?php echo $yorum; ?></p>
                        </td>
            ...
            <table style="background-color:#3A3A3A;width:60%;margin:0 auto;">
                    <tr style="margin:left;">
                        <td style="margin:left;">
                            <p style="color:#FFF"><?php echo $ad; ?><?php echo $soyad; ?></p>
                        </td>
                        <td style="margin:left;">
                            <p style="color:#FFF"><?php echo $tarih; ?></p>
                        </td>
