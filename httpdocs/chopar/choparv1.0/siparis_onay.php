...
<?php } ?>
    ...
    <div style="width:100%;height: auto;margin-top:30px;">
        ...
        if($_SESSION['user'] == session_id()){
            ?>
        <table style="width:50%;height:auto;margin:0 auto;">
            <form method="POST" action="onayla.php">
                <tr style="width:100%;height:auto;margin:0 auto;">
                    <td><p style="color:#FFD700;text-align:left;">Ad</p>
                    </td>
                    <td>
                        <input type="text" name="ad" placeholder="Ad" required>
                    </td>
                    <td><p style="color:#FFD700;text-align:left;">Soyad</p>
                    </td>
                    <td>
                ...
                <tr style="width:100%;height:auto;margin:0 auto;">
                    <td><p style="color:#FFD700;text-align:left;">Mail</p>
                    </td>
                    <td>
                        <input type="text" name="mail" placeholder="Mail" required>
                    </td>
                    <td><p style="color:#FFD700;text-align:left;">Telefon</p>
                    </td>
                    <td>
                ...
                <tr style="width:100%;height:auto;margin:0 auto;">
                    <td><p style="color:#FFD700;text-align:left;">Adres</p>
                    </td>
                    <td>
                        <textarea type="text" id="adres" name="adres" rows="4" cols="30" placeholder="Adres" required></textarea>
                    </td>
                    <td><p style="color:#FFD700;text-align:left;">Vergi/Kimlik Numarası</p>
                    </td>
                    <td style="color:#FFD700;">
                        <input type="text" name="no" placeholder="Vergi/Kimlik Numarası">(Kurumsal Fatura)
                    </td>
                </tr>
                <tr style="width:100%;height:auto;margin:0 auto;">
                    <td>
                        <input type="text" name="onay" value="tamam" style="display:none;">
                    </td>
                    <td>
        ...
        <?php
            ...
            <form method="POST" action="onayla.php">
                <table style="width:60%;height:auto;margin:0 auto;">
                    <tr>
                        <td style="color:#FFD700;">Adres Seçimi
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <table style="color:#FFD700;">
                                <tr>
                                    <td style="color:#FFD700;">
                                        <input type="radio" id="adres1" name="adres" value="<?php echo $adres1; ?>"><label for="option1"><?php echo $adres1_isim; ?></label><br><?php echo $adres1; ?>
                                        <input type="text" id="adres1_isim" name="adres1_isim" value="<?php echo $adres1_isim; ?>" style="display:none;">
                                        <input type="text" id="adres1_isim" name="adres_secim" value="1" style="display:none;">
                                    </td>
                                    <td style="width:20px;">
                                    </td>
                                    <?php if($adres2 != "" || $adres2 != null){ ?>
                                        <td style="color:#FFD700;">
                                            <input type="radio" id="adres2" name="adres2" value="<?php echo $adres2; ?>"><label for="option2"><?php echo $adres2_isim; ?></label><br><?php echo $adres2; ?>
                                            <input type="text" id="adres2_isim" name="adres2_isim" value="<?php echo $adres1_isim; ?>" style="display:none;">
                                            <input type="text" id="adres2_isim" name="adres_secim" value="2" style="display:none;">
                                        </td>
                                    <?php } ?>
                                    <td style="width:20px;">
                                    </td>
                                    <?php if($adres3 != "" || $adres3 != null){ ?>
                                        <td style="color:#FFD700;">
                                            <input type="radio" id="adres3" name="adres3" value="<?php echo $adres3; ?>"><label for="option3"><?php echo $adres3_isim; ?></label><br><?php echo $adres3; ?>
                                            <input type="text" id="adres3_isim" name="adres3_isim" value="<?php echo $adres1_isim; ?>" style="display:none;">
                                            <input type="text" id="adres3_isim" name="adres_secim" value="3" style="display:none;">
                                        </td>
                                    <?php } ?>
                                </tr>
                            </table>
