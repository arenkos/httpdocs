                ...
                <td>
                    <form action="mesaj.php" method="POST" style="text-align:center;width:80%;margin:0 auto;">
                        ...
                        <table style="text-align:left;">
                            <tr>
                                <td>
                                    <label style="color:black;font-size:20px;" for="ad">Ad</label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <label style="color:black;font-size:20px;" for="soyad">Soyad</label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <label style="color:black;font-size:20px;" for="mesaj">Mesaj</label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <label style="color:black;font-size:20px;" for="telefon">Telefon</label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <label style="color:black;font-size:20px;" for="email">Email</label>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p>Mimar Sinan Mah. Mimar Sinan Cad. Durmuş Delice İş Merkezi No: 25/2 Çekmeköy/İSTANBUL
                                    </p>
                                <td>
                            </tr>
                            <tr>
