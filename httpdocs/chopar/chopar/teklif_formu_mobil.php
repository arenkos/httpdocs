<div class="image-container" style="background-color: black; background-size: 100% 100%; display: flex;justify-content: flex-start; height: 100%; max-width:100%;margin-left:0px;">
