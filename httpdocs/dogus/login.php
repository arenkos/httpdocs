<?php	
	if(isset($_POST['student_number'])){
		...
		if($student_number == "202303011143" && $password == "1"){
			...
			?>
				<meta http-equiv="refresh" content="0; URL=system/light/system.php">
			<?php
			exit();
		}
		...
		<div class="login-panel">
			<form method="POST" action="login.php" accept-charset="UTF-8">
				...
				<table id="login-table">
					<tr>
						<td>
							<input id="student_number" type="tel" value="202303011143" name="student_number" placeholder="Öğrenci No / Student No" required oninput="this.value = this.value.replace(/[^0-9]/g, '')">
						</td>
					</tr>
					<tr>
						<td>
							<input id="password" type="password" name="password" value="1" placeholder="Şifre / Password" required>
						</td>
					</tr>
				</table>
