...
if($_COOKIE['theme'] == "dark"){
    ?>
    <meta http-equiv="refresh" content="0; URL=../dark/campus.php">
<?php
}else{
...
<html lang="tr">
	...
	<body>
		...
		<table id="desktop-campus" style="width:100%;height:100vh;">
			<tr>
						...
						<table class="parts-alt">
							<tr class="parts">
								<td id="activities" onclick="showbox('campus-alt', 'campus/show_activities.php')">
									<div class="options-icon-div">
										<img src="../../campus-light/activities.png?v=<?php echo time(); ?>" class="options-icon">
									</div>
								...
								<td id="clubs" onclick="showbox('campus-alt', 'campus/show_clubs.php')">
									<div class="options-icon-div">
										<img src="../../campus-light/clubs.png?v=<?php echo time(); ?>" class="options-icon">
									</div>
									<div class="spacer-height"></div>
									<div>
								...
								<td id="directions" onclick="showbox('campus-alt', 'campus/show_directions.php')">
									<div class="options-icon-div">
										<img src="../../campus-light/directions.png?v=<?php echo time(); ?>" class="options-icon">
									</div>
									<div class="spacer-height"></div>
									<div>
								...
								<td id="campus-plan" onclick="showbox('campus-alt', 'campus/show_campus_plan.php')">
									<div class="options-icon-div">
										<img src="../../campus-light/campus-plan.png?v=<?php echo time(); ?>" class="options-icon">
									</div>
									<div class="spacer-height"></div>
									<div>
							...
							<tr class="parts">
								<td id="food-list" onclick="showbox('campus-alt', 'campus/show_food_list.php')">
									<div class="options-icon-div">
										<img src="../../campus-light/food-list.png?v=<?php echo time(); ?>" class="options-icon">
									</div>
									<div class="spacer-height"></div>
									<div>
								...
								<td id="service-hours" onclick="showbox('campus-alt', 'campus/show_service_hours.php')">
									<div class="options-icon-div">
										<img src="../../campus-light/service-hours.png?v=<?php echo time(); ?>" class="options-icon">
									</div>
									<div class="spacer-height"></div>
									<div>
