...
if($_COOKIE['theme'] == "dark"){
    ?>
    <meta http-equiv="refresh" content="0; URL=../dark/obs.php">
<?php
}else{
						...
						<table class="parts-alt">
							<tr class="parts">
								<td id="academic-calendar" onclick="showbox('obs-alt', 'obs/show_academic_calendar.php')">
									<div class="options-icon-div">
										<img src="../../obs-light/academic-calendar.png?v=<?php echo time(); ?>" class="options-icon">
									</div>
								...
								<td id="course-register" onclick="showbox('obs-alt', 'obs/show_course_register.php')">
									<div class="options-icon-div">
										<img src="../../obs-light/course-register.png?v=<?php echo time(); ?>" class="options-icon">
									</div>
									<div class="spacer-height"></div>
									<div>
								...
								<td id="week-program" onclick="showbox('obs-alt', 'obs/show_week_program.php')">
									<div class="options-icon-div">
										<img src="../../obs-light/week-program.png?v=<?php echo time(); ?>" class="options-icon">
									</div>
									<div class="spacer-height"></div>
									<div>
								...
								<td id="exam-program" onclick="showbox('obs-alt', 'obs/show_exam_program.php')">
									<div class="options-icon-div">
										<img src="../../obs-light/exam-program.png?v=<?php echo time(); ?>" class="options-icon">
									</div>
									<div class="spacer-height"></div>
									<div>
							...
							<tr class="parts">
								<td id="grades-exam" onclick="showbox('obs-alt', 'obs/show_grades_exam.php')">
									<div class="options-icon-div">
										<img src="../../obs-light/grades-exam.png?v=<?php echo time(); ?>" class="options-icon">
									</div>
									<div class="spacer-height"></div>
									<div>
								...
								<td id="advisory-info" onclick="showbox('obs-alt', 'obs/show_advisory_info.php')">
									<div class="options-icon-div">
										<img src="../../obs-light/advisory-info.png?v=<?php echo time(); ?>" class="options-icon">
									</div>
									<div class="spacer-height"></div>
									<div>
								...
								<td id="transcript" onclick="showbox('obs-alt', 'obs/show_transcript.php')">
									<div class="options-icon-div">
										<img src="../../obs-light/transcript.png?v=<?php echo time(); ?>" class="options-icon">
									</div>
									<div class="spacer-height"></div>
									<div>
								...
								<td id="applications" onclick="showbox('obs-alt', 'obs/show_applications.php')">
									<div class="options-icon-div">
										<img src="../../obs-light/applications.png?v=<?php echo time(); ?>" class="options-icon">
									</div>
									<div class="spacer-height"></div>
									<div>
							...
							<tr class="parts">
								<td id="user-management" onclick="showbox('obs-alt', 'obs/show_user_management.php')">
									<div class="options-icon-div">
										<img src="../../obs-light/user-management.png?v=<?php echo time(); ?>" class="options-icon">
									</div>
									<div class="spacer-height"></div>
									<div>
