...
if($_COOKIE['theme'] == "dark"){
    ?>
    <meta http-equiv="refresh" content="0; URL=../dark/mail.php">
<?php
}else{
							...
							<tr class="parts">
								<td id="mails" onclick="showbox('mail-alt', 'mail/show_mails.php')">
									<div class="options-icon-div">
										<img src="../../mail-light/mails.png?v=<?php echo time(); ?>" class="options-icon">
									</div>
								...
								<td id="notes" onclick="showbox('mail-alt', 'mail/show_notes.php')">
									<div class="options-icon-div">
										<img src="../../mail-light/notes.png?v=<?php echo time(); ?>" class="options-icon">
									</div>
									<div class="spacer-height"></div>
									<div>
								...
								<td id="social" onclick="showbox('mail-alt', 'mail/show_social.php')">
									<div class="options-icon-div">
										<img src="../../mail-light/social.png?v=<?php echo time(); ?>" class="options-icon">
									</div>
									<div class="spacer-height"></div>
									<div>
