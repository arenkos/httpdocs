...
if($_COOKIE['theme'] == "light"){
    ?>
    <meta http-equiv="refresh" content="0; URL=../light/campus.php">
<?php
}else{
						...
						<table class="parts-alt">
							<tr class="parts">
								<td id="activities" onclick="showbox('campus-alt', 'campus/show_activities.php')">
									<div class="options-icon-div">
										<img src="../../campus-dark/activities.png?v=<?php echo time(); ?>" class="options-icon">
									</div>
								...
								<td id="clubs" onclick="showbox('campus-alt', 'campus/show_clubs.php')">
									<div class="options-icon-div">
										<img src="../../campus-dark/clubs.png?v=<?php echo time(); ?>" class="options-icon">
									</div>
									<div class="spacer-height"></div>
									<div>
								...
								<td id="directions" onclick="showbox('campus-alt', 'campus/show_directions.php')">
									<div class="options-icon-div">
										<img src="../../campus-dark/directions.png?v=<?php echo time(); ?>" class="options-icon">
									</div>
									<div class="spacer-height"></div>
									<div>
								...
								<td id="campus-plan" onclick="showbox('campus-alt', 'campus/show_campus_plan.php')">
									<div class="options-icon-div">
										<img src="../../campus-dark/campus-plan.png?v=<?php echo time(); ?>" class="options-icon">
									</div>
									<div class="spacer-height"></div>
									<div>
							...
							<tr class="parts">
								<td id="food-list" onclick="showbox('campus-alt', 'campus/show_food_list.php')">
									<div class="options-icon-div">
										<img src="../../campus-dark/food-list.png?v=<?php echo time(); ?>" class="options-icon">
									</div>
									<div class="spacer-height"></div>
									<div>
								...
								<td id="service-hours" onclick="showbox('campus-alt', 'campus/show_service_hours.php')">
									<div class="options-icon-div">
										<img src="../../campus-dark/service-hours.png?v=<?php echo time(); ?>" class="options-icon">
									</div>
									<div class="spacer-height"></div>
									<div>
