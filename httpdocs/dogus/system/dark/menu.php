...
<div id="menu-button" onmouseover="toggleMenu()"><img id="menu-img" src="menu.png"></div>
<div id="menu-button-mobile" onclick="toggleMenu_mobile()"><img id="menu-img-mobile" src="menu.png"></div>

<div id="menu" onmouseover="checkAndToggleMenu();" onmouseout="checkAndHideMenu();">
	<table style="height:100%;width:100%;">
		...
		<tr class="menu-parts">
			<td style="background-color:#151515;text-align:center;margin:0 auto;width:100%;height:auto;max-height:100%;">
