...
<div id="menu">	
	<table style="height:100%;width:100%;">
		...
		<tr class="menu-parts">
			<td style="background-color:#151515;text-align:center;margin:0 auto;width:100%;height:auto;">
				<table style="text-align:center;margin:0 auto;width:80%;height:auto;">
					<tr id="menu-obs">
