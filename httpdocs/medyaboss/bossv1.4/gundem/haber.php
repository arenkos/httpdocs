...
if($_GET['haber'] == 3 || $_GET['haber'] == 1){
	?><meta http-equiv="refresh" content="0; URL=haberv.php?haber=<?php echo $_GET['haber']; ?>">
    <?php
}
else if (strpos($userAgent, 'Mobile') == true) {
            ...
            <table style="text-align:justify;">
                ...
                <tr style="text-align:justify;height:500px;width:500px;">
                    <td>
                        ...
                        ?>
                            <img src="https://www.medyabosshaber.com/mboss/gundem/haber<?php echo $_GET['haber']; ?>-1.png" style="width:1000px;height:500px;padding-top:20px;">
                        <?php } ?>
                    </td>
                ...
                <tr>
                    <td>
                        <div>
                            ...
                            ?>
                                <img src="https://www.medyabosshaber.com/mboss/gundem/haber<?php echo $_GET['haber']; ?>-2.png" style="width:1000px;height:500px;">
                            <?php } ?>
                        </div>
                    </td>
                </tr>
