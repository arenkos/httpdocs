    ...
    <tr>
        ...
        <td>
            <div style="height:100px;">
                <a href="haber.php?haber=1" style="text-decoration:none;color:#000"><img src="https://www.medyabosshaber.com/mboss/gundem/haber1.png" style="width:150px;height:100px;"></a>
            </div>
        </td>
        <td>
...
?></a>
    ...
    <tr>
        ...
        <td>
            <div style="height:100px;">
                <a href="haber.php?haber=2" style="text-decoration:none;color:#000"><img src="https://www.medyabosshaber.com/mboss/gundem/haber2.png" style="width:150px;height:100px;"></a>
            </div>
        </td>
        <td>
            <div style="background-color:#ededed;text-align:justify;width:220px;height:100px;font-size:15px;font-family:Poppins;padding-left:10px;padding-right:10px;">
...
?></a>
    ...
    <tr>
        ...
        <td>
            <div style="height:100px;">
                <a href="haber.php?haber=3" style="text-decoration:none;color:#000"><img src="https://www.medyabosshaber.com/mboss/gundem/haber3.png" style="width:150px;height:100px;"></a>
            </div>
        </td>
        <td>
            <div style="background-color:#ededed;text-align:justify;width:220px;height:100px;font-size:15px;font-family:Poppins;padding-left:10px;padding-right:10px;">
...
?></a>
    ...
    <tr>
        ...
        <td>
            <div style="height:100px;">
                <a href="haber.php?haber=4" style="text-decoration:none;color:#000"><img src="https://www.medyabosshaber.com/mboss/gundem/haber4.png" style="width:150px;height:100px;"></a>
            </div>
        </td>
        <td>
            <div style="background-color:#ededed;text-align:justify;width:220px;height:100px;font-size:15px;font-family:Poppins;padding-left:10px;padding-right:10px;">
