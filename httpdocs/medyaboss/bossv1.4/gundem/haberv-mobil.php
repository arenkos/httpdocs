            ...
            <table style="text-align:justify;width:100%;">
                ...
                <tr style="text-align:justify;height:500px;width:100%">
                    <td>
						...
						<?php if ($_GET['haber'] == 3){ ?>
                          <source src="https://www.medyabosshaber.com/mboss/gundem/video.mp4" type="video/mp4">
						<?php }else{ ?>
							<source src="https://www.medyabosshaber.com/mboss/gundem/video2.mp4" type="video/mp4">
						<?php } ?>
