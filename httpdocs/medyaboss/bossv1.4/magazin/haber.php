            ...
            <table style="text-align:justify;">
                ...
                <tr style="text-align:justify;height:500px;width:500px;">
                    <td>
                        ...
                        ?>
                            <img src="https://www.medyabosshaber.com/mboss/magazin/haber<?php echo $_GET['haber']; ?>-1.png" style="width:1000px;height:500px;padding-top:20px;">
                        <?php } ?>
                    </td>
                ...
                <tr>
                    <td>
                        <div>
                            ...
                            ?>
                                <img src="https://www.medyabosshaber.com/mboss/magazin/haber<?php echo $_GET['haber']; ?>-2.png" style="width:1000px;height:500px;">
                            <?php } ?>
                        </div>
                    </td>
                </tr>
