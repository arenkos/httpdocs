                            ...
                            <tr style="width:100%">
                                ...
                                <td style="width:50%;">
                                    <table style="width:100%">
                                        <tr style="width:100%">
                                            <td style="width:100%">
                                                <a style="text-decoration:none;color:#000" target="_blank" href="haber-mobil.php?ktg=gundem&haber=<?php echo $total_gundem - 3; ?>"><img src="https://www.medyabosshaber.com/mboss/gundem/haber<?php echo $total_gundem - 3; ?>.png" style="width:100%;height:165px;"></a>
                                            </td>
                                        </tr>
                                        <tr style="width:100%">
                                            <td style="width:100%">
