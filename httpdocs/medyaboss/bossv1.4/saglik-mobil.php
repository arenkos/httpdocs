                                            ...
                                            <td style="width:90%;">
                                                <div>
                                                  <?php
                                                    ...
                                                    echo '<a id="hbr" href="saglik/haber.php?haber=' . $id . '"><img id="slayt" src="../mboss/saglik/haber' . $id . '.png" width="100%" height="310px"></a>';
                                                  ?>
                                                </div>
                                            </td>
                                            <td style="width:5%;">
                                        ...
                                        <tr style="width:100%">
                                            <td style="width:100%">
                                                <?php
                                                    ...
                                                    $id = $row2['total'];
                                                ?>
                                                <a target="_blank" style="text-decoration:none;" href="haber-mobil.php?ktg=saglik&haber=<?php echo $id; ?>"><img src="../mboss/saglik/haber<?php echo $id; ?>.png" style="width:100%;height:205px;"></a>
                                            </td>
                                        </tr>
                                        <tr style="width:100%">
                                            <td style="width:100%">
                                                <a target="_blank" style="text-decoration:none;" href="haber-mobil.php?ktg=saglik&haber=1"><div style="text-align:justify;text-decoration:none;width:100%;height:100px;color:black;font-size:15px;">
                                                    <?php
