...
?>
    ...
    ?></title>
    <link rel="icon" href="http://www.armedyaveteknoloji.xyz/medyaboss/mboss/logo.png" type="image/x-icon">
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    <video style="width:100%;height:500px;padding-top:20px;" controls>
                                        <source src="http://www.armedyaveteknoloji.xyz/medyaboss/mboss/<?php echo $kategori; ?>/<?php echo $row['resim1']; ?>.mp4" type="video/mp4">
                                    </video><?php
                                }
                            }else{
                        ?>
                            <img src="http://www.armedyaveteknoloji.xyz/medyaboss/mboss/<?php echo $kategori; ?>/haber<?php echo $_GET['haber']; ?>-1.png" style="width:100%;height:500px;padding-top:20px;">
                        <?php } ?>
                    </td>
                </tr>
                <tr>
                ...
                <tr style="text-align:justify;height:500px;width:100%;padding-right:10px;">
                    <td>
                        <div>
                            ...
                            ?>
                                <img src="http://www.armedyaveteknoloji.xyz/medyaboss/mboss/<?php echo $kategori; ?>/haber<?php echo $_GET['haber']; ?>-2.png" style="width:100%;height:500px;padding-right:10px;">
                            <?php } ?>
                        </div>
                    </td>
                </tr>
						...
						<tr>
							<td style="width:30%;height:200px;">
								<div style="width:100%;height:200px;">
                                    <a href="haber-mobil.php?ktg=<?php echo $kategori; ?>&haber=<?php if($_GET['haber'] - 1 == 0){ $resim = $total;}else{ $resim = $_GET['haber']; }  echo $resim; ?>" style="text-decoration:none;color:#000"><img src="http://www.armedyaveteknoloji.xyz/medyaboss/mboss/<?php echo $kategori; ?>/haber<?php if($_GET['haber'] - 1 == 0){ $resim = $total;}else{ $resim = $_GET['haber'] - 1; } echo $resim;?>.png" style="width:100%;height:200px;"></a>
								</div>
							</td>
							<td style="width:40%">
							</td>
							<td style="width:30%;height:200px;">
								<div style="width:100%;height:200px;">
                                    <a href="haber-mobil.php?ktg=<?php echo $kategori; ?>&haber=<?php if($_GET['haber'] + 1 > $total){ $resim = 1;}else{ $resim = $_GET['haber']; } echo $resim;?>" style="text-decoration:none;color:#000"><img src="http://www.armedyaveteknoloji.xyz/medyaboss/mboss/<?php echo $kategori; ?>/haber<?php if($_GET['haber'] + 1 > $total){ $resim = 1;}else{ $resim = $_GET['haber'] + 1; }  echo $resim;?>.png" style="width:100%;height:200px;"></a>
								</div>
							</td>
						</tr>
						<tr style="height:auto;">
