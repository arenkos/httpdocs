...
if (strpos($userAgent, 'Mobile') == true) {
    ?><meta http-equiv="refresh" content="0; URL=saglik-mobil.php?mail=<?php echo $_GET['mail']; ?>">
    <?php
}
?>
<meta charset="utf-8">
        ...
        <div style="width:100%;height:50px;background:#CD0000;margin: 0 auto;">
            <table style="width:1540px;height:50px;background:#CD0000;margin: 0 auto;text-align:justify;">
                <tr>
                    ...
                    <td><img src="cizgi.png" style="height:32px;width:2px;padding-top:15px;padding-left:0px;padding-right:0px;"></td>
                    <td style="width:120px"><a onmouseover="this.style.color='#FFB600';" onmouseout="this.style.color=#FFB600;" style="width:155px;background:#CD0000;font-size:15px;font-family:Poppins;text-decoration: none;color:#FFB600;" href="saglik.php?mail=<?php echo $_GET['mail']; ?>">Sağlık</a></td>
                    <td><img src="cizgi.png" style="height:32px;width:2px;padding-top:15px;padding-left:0px;padding-right:0px;"></td>
        ...
        <td>
            <div style="padding-top:50px;width:1540px;margin: 0 auto;">
                    ...
                    <tr>
                        ...
                        <td>
                            <script>
                                ...
                                document.getElementById("slayt").src = "../mboss/saglik/haber" + imageIndex + ".png";
                                document.getElementById("hbr").href = "saglik/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=" + imageIndex;
                                document.getElementById("hbr").target = "_blank";
                                document.getElementById("secim"+imageIndex).src = "dolu.png";

                                }
                                function go(index){
                                  window.location = "saglik/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=" + index;
                                }
                                function degis(){
                                  document.getElementById("secim"+imageIndex).src = "dolu.png";
                                }
                                ...
                                function showImage(imageIndex) {
                                    ...
                                    imageElement.src = "../mboss/saglik/haber" + imageIndex + ".png";
                            ...
                            <div>
                              <?php
                                ...
                                echo '<a id="hbr" href="saglik/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=' . $selected_image . '"><img id="slayt" src="../mboss/saglik/haber' . $selected_image . '.png" width="990px" height="610px"></a>';
                              ?>
                            </div>
                        ...
                        <td>
                            <table>
                                <tr>
                                    <td>
                                        <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=1"><img src="../mboss/saglik/haber1.png" style="width:510px;height:205px;"></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=1">
                                            <div style="text-align:justify;text-decoration:none;width:510px;height:100px;color:black;font-size:20px;padding-bottom:15px;">
                                                <?php
                                                    $sql = "SELECT baslik FROM saglik WHERE resim= 1";
                                ...
                                <tr>
                                    <td>
                                        <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=2"><img src="../mboss/saglik/haber2.png" style="width:510px;height:205px;padding-bottom:25px;"></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=2">
                                        <div style="text-align:justify;text-decoration:none;width:510px;height:100px;color:black;font-size:20px;padding-bottom:15px;">
                                            <?php
                                                $sql = "SELECT baslik FROM saglik WHERE resim= 2";
                                                mysqli_set_charset($connection, "utf8");
                                                $result = mysqli_query($connection, $sql);
                                                if (mysqli_num_rows($result) > 0) {
                                                    while ($row = mysqli_fetch_assoc($result)) {
                ...
                <table style="width:1540px;margin: 0 auto;">
                    <tr>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=3"><img src="../mboss/saglik/haber3.png" style="width:250px;height:250px;"></a>
                        </td>
                        <td style="width:10px;">
                        </td>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=3">
                                <div style="text-align:justify;text-decoration:none;width:510px;height:100px;color:black;font-size:20px;padding-bottom:15px;">
                                    <?php
                                        $sql = "SELECT baslik FROM saglik WHERE resim= 3";
                                        mysqli_set_charset($connection, "utf8");
                                        $result = mysqli_query($connection, $sql);
                                        if (mysqli_num_rows($result) > 0) {
                                            while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=4"><img src="../mboss/saglik/haber4.png" style="width:250px;height:250px;"></a>
                        </td>
                        <td style="width:10px;">
                        </td>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=4">
                                <div style="text-align:justify;text-decoration:none;width:510px;height:100px;color:black;font-size:20px;padding-bottom:15px;">
                                    <?php
                                        $sql = "SELECT baslik FROM saglik WHERE resim= 4";
                                        mysqli_set_charset($connection, "utf8");
                                        $result = mysqli_query($connection, $sql);
                                        if (mysqli_num_rows($result) > 0) {
                                            while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <tr>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=5"><img src="../mboss/saglik/haber5.png" style="width:250px;height:250px;"></a>
                        </td>
                        <td style="width:10px;">
                        </td>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=5">
                                <div style="text-align:justify;text-decoration:none;width:510px;height:100px;color:black;font-size:20px;padding-bottom:15px;">
                                    <?php
                                        $sql = "SELECT baslik FROM saglik WHERE resim= 5";
                                        mysqli_set_charset($connection, "utf8");
                                        $result = mysqli_query($connection, $sql);
                                        if (mysqli_num_rows($result) > 0) {
                                            while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=6"><img src="../mboss/saglik/haber6.png" style="width:250px;height:250px;"></a>
                        </td>
                        <td style="width:10px;">
                        </td>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=6">
                                    <div style="text-align:justify;text-decoration:none;width:510px;height:100px;color:black;font-size:20px;padding-bottom:15px;">
                                        <?php
                                            $sql = "SELECT baslik FROM saglik WHERE resim= 6";
                                            mysqli_set_charset($connection, "utf8");
                                            $result = mysqli_query($connection, $sql);
                                            if (mysqli_num_rows($result) > 0) {
                                                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <tr>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=7"><img src="../mboss/saglik/haber7.png" style="width:250px;height:250px;"></a>
                        </td>
                        <td style="width:10px;">
                        </td>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=7">
                                <div style="text-align:justify;text-decoration:none;width:510px;height:100px;color:black;font-size:20px;padding-bottom:15px;">
                                    <?php
                                        $sql = "SELECT baslik FROM saglik WHERE resim= 7";
                                        mysqli_set_charset($connection, "utf8");
                                        $result = mysqli_query($connection, $sql);
                                        if (mysqli_num_rows($result) > 0) {
                                            while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=8"><img src="../mboss/saglik/haber8.png" style="width:250px;height:250px;"></a>
                        </td>
                        <td style="width:10px;">
                        </td>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=8">
                                    <div style="text-align:justify;text-decoration:none;width:510px;height:100px;color:black;font-size:20px;padding-bottom:15px;">
                                        <?php
                                            $sql = "SELECT baslik FROM saglik WHERE resim= 8";
                                            mysqli_set_charset($connection, "utf8");
                                            $result = mysqli_query($connection, $sql);
                                            if (mysqli_num_rows($result) > 0) {
                                                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <tr>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=9"><img src="../mboss/saglik/haber9.png" style="width:250px;height:250px;"></a>
                        </td>
                        <td style="width:10px;">
                        </td>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=9">
                                <div style="text-align:justify;text-decoration:none;width:510px;height:100px;color:black;font-size:20px;padding-bottom:15px;">
                                    <?php
                                        $sql = "SELECT baslik FROM saglik WHERE resim= 9";
                                        mysqli_set_charset($connection, "utf8");
                                        $result = mysqli_query($connection, $sql);
                                        if (mysqli_num_rows($result) > 0) {
                                            while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=10"><img src="../mboss/saglik/haber10.png" style="width:250px;height:250px;"></a>
                        </td>
                        <td style="width:10px;">
                        </td>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=10">
                                <div style="text-align:justify;text-decoration:none;width:510px;height:100px;color:black;font-size:20px;padding-bottom:15px;">
                                    <?php
                                        $sql = "SELECT baslik FROM saglik WHERE resim= 10";
                                        mysqli_set_charset($connection, "utf8");
                                        $result = mysqli_query($connection, $sql);
                                        if (mysqli_num_rows($result) > 0) {
                                            while ($row = mysqli_fetch_assoc($result)) {
