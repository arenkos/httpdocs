...
if (strpos($userAgent, 'Mobile') == true) {
    ?><meta http-equiv="refresh" content="0; URL=teknoloji-mobil.php?mail=<?php echo $_GET['mail']; ?>">
    <?php
}
?>
<meta charset="utf-8">
		...
		<div style="width:100%;height:50px;background:#CD0000;margin: 0 auto;">
			<table style="width:1540px;height:50px;background:#CD0000;margin: 0 auto;text-align:justify;">
				<tr>
					...
					<td><img src="cizgi.png" style="height:32px;width:2px;padding-top:15px;padding-left:0px;padding-right:0px;"></td>
					<td style="width:120px"><a onmouseover="this.style.color='#FFB600';" onmouseout="this.style.color='#FFB600';" style="width:155px;background:#CD0000;font-size:15px;font-family:Poppins;text-decoration: none;color:#FFB600;" href="teknoloji.php?mail=<?php echo $_GET['mail']; ?>">Teknoloji</a></td>
					<td><img src="cizgi.png" style="height:32px;width:2px;padding-top:15px;padding-left:0px;padding-right:0px;"></td>
        ...
        <td>
            <div style="padding-top:50px;width:1540px;margin: 0 auto;">
                    ...
                    <tr>
                        ...
                        <td>
                            <script>
                                ...
                                document.getElementById("hbr").href = "teknoloji/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=" + imageIndex;
                                document.getElementById("hbr").target = "_blank";
                                document.getElementById("secim"+imageIndex).src = "dolu.png";

                                }
                                function go(index){
                                  window.location = "teknoloji/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=" + index;
                                }
                                function degis(){
                                  document.getElementById("secim"+imageIndex).src = "dolu.png";
                                }
                            ...
                            <div>
                              <?php
                                ...
                                echo '<a id="hbr" href="teknoloji/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=' . $selected_image . '"><img id="slayt" src="../mboss/teknoloji/haber' . $selected_image . '.png" width="990px" height="610px"></a>';
                              ?>
                            </div>
                        ...
                        <td>
                            <table>
                                <tr>
                                    <td>
                                        <a target="_blank" style="text-decoration:none;" href="teknoloji/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=1"><img src="../mboss/teknoloji/haber1.png" style="width:510px;height:205px;"></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <a target="_blank" style="text-decoration:none;" href="teknoloji/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=1">
                                ...
                                <tr>
                                    <td>
                                        <a target="_blank" style="text-decoration:none;" href="teknoloji/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=2"><img src="../mboss/teknoloji/haber2.png" style="width:510px;height:205px;padding-bottom:25px;"></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <a target="_blank" style="text-decoration:none;" href="teknoloji/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=2">
                                        <div style="text-align:justify;text-decoration:none;width:510px;height:100px;color:black;font-size:20px;padding-bottom:15px;">
                                            <?php
                ...
                <table style="width:1540px;margin: 0 auto;">
                    <tr>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="teknoloji/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=3"><img src="../mboss/teknoloji/haber3.png" style="width:250px;height:250px;"></a>
                        </td>
                        <td style="width:10px;">
                        </td>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="teknoloji/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=3">
                                <div style="text-align:justify;text-decoration:none;width:510px;height:100px;color:black;font-size:20px;padding-bottom:15px;">
                                    <?php
                        ...
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="teknoloji/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=4"><img src="../mboss/teknoloji/haber4.png" style="width:250px;height:250px;"></a>
                        </td>
                        <td style="width:10px;">
                        </td>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="teknoloji/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=4">
                                <div style="text-align:justify;text-decoration:none;width:510px;height:100px;color:black;font-size:20px;padding-bottom:15px;">
                                    <?php
                    ...
                    <tr>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="teknoloji/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=5"><img src="../mboss/teknoloji/haber5.png" style="width:250px;height:250px;"></a>
                        </td>
                        <td style="width:10px;">
                        </td>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="teknoloji/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=5">
                                <div style="text-align:justify;text-decoration:none;width:510px;height:100px;color:black;font-size:20px;padding-bottom:15px;">
                                    <?php
                        ...
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="teknoloji/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=6"><img src="../mboss/teknoloji/haber6.png" style="width:250px;height:250px;"></a>
                        </td>
                        <td style="width:10px;">
                        </td>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="teknoloji/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=6">
                                    <div style="text-align:justify;text-decoration:none;width:510px;height:100px;color:black;font-size:20px;padding-bottom:15px;">
                                        <?php
                    ...
                    <tr>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="teknoloji/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=7"><img src="../mboss/teknoloji/haber7.png" style="width:250px;height:250px;"></a>
                        </td>
                        <td style="width:10px;">
                        </td>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="teknoloji/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=7">
                                <div style="text-align:justify;text-decoration:none;width:510px;height:100px;color:black;font-size:20px;padding-bottom:15px;">
                                    <?php
                        ...
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="teknoloji/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=8"><img src="../mboss/teknoloji/haber8.png" style="width:250px;height:250px;"></a>
                        </td>
                        <td style="width:10px;">
                        </td>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="teknoloji/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=8">
                                    <div style="text-align:justify;text-decoration:none;width:510px;height:100px;color:black;font-size:20px;padding-bottom:15px;">
                                        <?php
                    ...
                    <tr>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="teknoloji/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=9"><img src="../mboss/teknoloji/haber9.png" style="width:250px;height:250px;"></a>
                        </td>
                        <td style="width:10px;">
                        </td>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="teknoloji/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=9">
                                <div style="text-align:justify;text-decoration:none;width:510px;height:100px;color:black;font-size:20px;padding-bottom:15px;">
                                    <?php
                        ...
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="teknoloji/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=10"><img src="../mboss/teknoloji/haber10.png" style="width:250px;height:250px;"></a>
                        </td>
                        <td style="width:10px;">
                        </td>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="teknoloji/haber.php?mail=<?php echo $_GET['mail']; ?>&haber=10">
                                <div style="text-align:justify;text-decoration:none;width:510px;height:100px;color:black;font-size:20px;padding-bottom:15px;">
                                    <?php
