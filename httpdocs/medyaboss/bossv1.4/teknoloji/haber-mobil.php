...
if (strpos($userAgent, 'Mobile') == false) {
    ...
    ?>
        <?php
            ...
            $resim = $_GET['haber'];
            $sql = "SELECT baslik FROM teknoloji WHERE resim= '$resim'";
...
<body>
    <?php
		...
		$resim = $_GET['haber'];
		$sql = "UPDATE teknoloji SET tiklanma_mobil = tiklanma_mobil + 1 WHERE resim= '$resim'";
    ...
    <main style="text-align:center;padding-top:122px;background-color:#fff;margin: 0 auto;width:100%;margin-left:10px;margin-right:10px;">
        ...
        <div style="margin: 0 auto;width:100%;text-align:justify;">
            <div style="text-align:left;margin-top:300px;">
                <p style="text-align:left;font-family:Poppins;color:#000;"><a href="../ana.php" style="text-decoration:none;color:#000;">Ana Sayfa</a> > <a href="../teknoloji.php" style="text-decoration:none;color:#000;">Teknoloji</a> >
                    <?php
                        $resim = $_GET['haber'];
                        $sql = "SELECT baslik FROM teknoloji WHERE resim= '$resim'";
                        mysqli_set_charset($connection, "utf8");
            ...
            <table style="text-align:justify;width:100%;">
                ...
                <tr style="text-align:justify;height:500px;width:100%">
                    <td>
                        <?php
                            $resim = $_GET['haber'];
                            $sql = "SELECT * FROM teknoloji WHERE resim= '$resim' AND format = 'mp4'";
                            mysqli_set_charset($connection, "utf8");
                            $result = mysqli_query($connection, $sql);
                            if (mysqli_num_rows($result) > 0) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    <video style="width:100%;height:500px;padding-top:20px;" controls>
                                        <source src="https://www.medyabosshaber.com/mboss/teknoloji/<?php echo $row['resim1']; ?>.mp4" type="video/mp4">
                                    </video><?php
                                }
                            }else{
                        ?>
                            <img src="https://www.medyabosshaber.com/mboss/teknoloji/haber<?php echo $_GET['haber']; ?>-1.png" style="width:100%;height:500px;padding-top:20px;">
                        <?php } ?>
                    </td>
                ...
                <tr>
                    <td>
                        <div style="padding-top:10px;text-align:justify;width:100%;height:auto;font-size:20px;font-family:Poppins;">
                            <?php
                                $resim = $_GET['haber'];
                                $sql = "SELECT icerik1 FROM teknoloji WHERE resim= '$resim'";
                                mysqli_set_charset($connection, "utf8");
                                $result = mysqli_query($connection, $sql);
                                if (mysqli_num_rows($result) > 0) {
                                    while ($row = mysqli_fetch_assoc($result)) {
                ...
                <tr>
                    <td>
                        <div>
                            ...
                            ?>
                                <img src="https://www.medyabosshaber.com/mboss/teknoloji/haber<?php echo $_GET['haber']; ?>-2.png" style="width:100%;height:500px;">
                            <?php } ?>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td>
                        <div style="padding-top:10px;text-align:justify;width:100%;height:auto;font-size:20px;font-family:Poppins;">
                            <?php
                                $resim = $_GET['haber'];
                                $sql = "SELECT icerik2 FROM teknoloji WHERE resim= '$resim'";
                                mysqli_set_charset($connection, "utf8");
                                $result = mysqli_query($connection, $sql);
                                if (mysqli_num_rows($result) > 0) {
                                    while ($row = mysqli_fetch_assoc($result)) {
						...
						<tr>
							<td style="width:30%;height:200px;">
								<div style="width:100%;height:200px;">
									<a href="haber-mobil.php?haber=<?php $resim = ($_GET['haber'] - 1)%11; if($resim == 0){ $resim = 10;}  echo $resim;?>" style="text-decoration:none;color:#000"><img src="https://www.medyabosshaber.com/mboss/teknoloji/haber<?php $resim = ($_GET['haber'] - 1)%11; if($resim == 0){ $resim = 10;} echo $resim;?>.png" style="width:100%;height:200px;"></a>
								</div>
							</td>
							<td style="width:40%">
							</td>
							<td style="width:30%;height:200px;">
								<div style="width:100%;height:200px;">
									<a href="haber-mobil.php?haber=<?php $resim = ($_GET['haber'] + 1)%11; if($resim == 0){ $resim = 1;}  echo $resim;?>" style="text-decoration:none;color:#000"><img src="https://www.medyabosshaber.com/mboss/teknoloji/haber<?php $resim = ($_GET['haber'] + 1)%11; if($resim == 0){ $resim = 1;}  echo $resim;?>.png" style="width:100%;height:200px;"></a>
								</div>
							</td>
						</tr>
						<tr style="height:auto;">
