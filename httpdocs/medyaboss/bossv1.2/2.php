...
<link
    ...
    />
<meta http-equiv="refresh" content="0; URL=gundem/haber.php?haber=2">
<?php
	...
	<main style="text-align:center;padding-top:122px;background-color:#fff;margin: 0 auto;">
		...
		<div style="margin: 0 auto;width:1540px;text-align:justify;">
			<div style="text-align:left;margin-top:300px;">
				<p style="text-align:left;font-family:Poppins;color:#000;"><a href="ana.php" style="text-decoration:none;color:#000;">Ana Sayfa</a> > <a href="ekonomi.php" style="text-decoration:none;color:#000;">Ekonomi</a> > Küresel piyasalar gelecek hafta neye bakacak?</p>
			</div>
			<table style="text-align:justify;">
				<tr>
					<td style="text-align:left;font-size:50px;font-family:Poppins;width:500px;">
						<p style="text-align:left;"><b>Küresel piyasalar gelecek hafta neye bakacak?</b></p>
					</td>
				...
				<tr style="text-align:justify;height:500px;width:500px;">
					<td>
						<img src="../bossv1.4/haber2-1.webp" style="width:1000px;height:500px;padding-top:20px;">
					</td>
				...
				<tr>
					<td>
						<div style="padding-top:10px;text-align:justify;width:1000px;height:530px;font-size:20px;font-family:Poppins;">
							Küresel pay piyasaları, ABD ve Avrupa merkez bankalarının para politikası kararlarını açıkladığı haftada karışık bir seyir izlerken, gelecek hafta için gözler ABD enflasyon verilerine çevrildi. Yatırımcıların geçen hafta odağında merkez bankaları, yoğun makroekonomik takvim ve bilançolar bulunurken, alınan karışık sinyaller piyasaların yön bulmasını zorlaştırdı.
...
Analistler, para piyasalarındaki fiyatlamalarda bankanın haziranda faiz artışını durduracağına kesin gözüyle bakıldığını ancak Fed Başkanı Jerome Powell'ın, faiz kararının ardından düzenlediği basın toplantısında, faiz artırımlarının durdurulup durdurulmayacağının haziran toplantısında ele alınacağını söylediğini hatırlattı. Geçen hafta ülkede açıklanan verilere göre, iş gücü piyasasının güçlü seyrinin sürdüğünü belirten analistler, söz konusu verilerin Fed'in politika alanına ilişkin elini rahatlattığını kaydetti.
						</div>
					</td>
				</tr>
				<tr>	
					<td>
						<div>
							<img src="../bossv1.4/haber2-2.webp" style="width:1000px;height:500px;">
						</div>
					</td>
				</tr>
				<tr>	
