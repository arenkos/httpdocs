...
if (strpos($userAgent, 'Mobile') == false) {
    ?><meta http-equiv="refresh" content="0; URL=6.php">
    <?php
}
?>
		...
		<div style="margin: 0 auto;width:100%;text-align:justify;">
			...
			<table style="text-align:justify;">
				...
				<tr style="text-align:justify;height:500px;width:100%;">
					<td>
						<img src="../bossv1.4/haber6-1.webp" style="width:100%;height:500px;padding-top:20px;">
					</td>
				</tr>
				<tr>
					<td>
...
ZTE U50 Pro, NFC mobil telefon bağlantısı özelliği sayesinde kullanıcıların mobil telefonlarını cihaza hızlı ve kolay bir şekilde bağlamasını sağlar. Cihaz, 18W çıkış sağlayarak diğer cihazları şarj etmek için bir güç bankası olarak da kullanılabilir. Cihazın kompakt boyutu, taşıması kolay olmasını sağlar.
				...
				<tr>	
					<td>
						<div>
							<img src="../bossv1.4/haber6-2.webp" style="width:100%;height:500px;">
						</div>
					</td>
				</tr>
				<tr>	
