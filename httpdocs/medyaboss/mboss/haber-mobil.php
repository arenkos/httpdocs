    ...
    <main style="text-align:center;padding-top:122px;background-color:#fff;margin: 0 auto;width:100%">
        ...
        <div style="margin: 0 auto;width:100%;text-align:justify;">
            <div style="text-align:left;margin-top:300px;">
                <p style="text-align:left;font-family:Poppins;color:#000;"><a href="../ana.php" style="text-decoration:none;color:#000;">Ana Sayfa</a> > <a href="../<?php echo $_GET['kategori']; ?>.php" style="text-decoration:none;color:#000;"><?php echo ucfirst($_GET['kategori']); ?></a> >
                    <?php
                        $resim = $_GET['haber'];
            ...
            <table style="text-align:justify;width:100%;">
                ...
                <tr style="text-align:justify;height:500px;width:100%">
                    <td>
                        <img src="https://www.medyabosshaber.com/bossv1.8/<?php echo $_GET['kategori']; ?>/haber<?php echo $_GET['haber']; ?>-1.webp" style="width:100%;height:500px;padding-top:20px;">
                    </td>
                ...
                <tr>
                    <td>
                        <div>
                            <img src="https://www.medyabosshaber.com/bossv1.8/<?php echo $_GET['kategori']; ?>/haber<?php echo $_GET['haber']; ?>-2.webp" style="width:100%;height:500px;">
                        </div>
                    </td>
                </tr>
                <tr>
