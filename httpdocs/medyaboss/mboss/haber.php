        ...
        <div style="margin: 0 auto;width:1540px;text-align:justify;">
            ...
            <table style="text-align:justify;">
                ...
                <tr style="text-align:justify;height:500px;width:500px;">
                    <td>
                        <img src="https://www.medyabosshaber.com/bossv1.8/<?php echo $_GET['kategori']; ?>/haber<?php echo $_GET['haber']; ?>-1.webp" style="width:1000px;height:500px;padding-top:20px;">
                    </td>
                ...
                <tr>
                    <td>
                        <div>
                            <img src="https://www.medyabosshaber.com/bossv1.8/<?php echo $_GET['kategori']; ?>/haber<?php echo $_GET['haber']; ?>-2.webp" style="width:1000px;height:500px;">
                        </div>
                    </td>
                </tr>
                <tr>
