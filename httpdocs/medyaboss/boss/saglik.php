				...
				<div style="width:100%;height:50px;background:#CD0000;margin: 0 auto;">
					<table style="width:1540px;height:50px;background:#CD0000;margin: 0 auto;text-align:justify;">
						<tr>
							...
							<td><img src="cizgi.png" style="height:32px;width:2px;padding-top:15px;padding-left:0px;padding-right:0px;"></td>
							<td style="width:120px"><a onmouseover="this.style.color='#FFB600';" onmouseout="this.style.color=#FFB600;" style="width:155px;background:#CD0000;font-size:15px;font-family:Poppins;text-decoration: none;color:#FFB600;" href="saglik.php">Sağlık</a></td>
							<td><img src="cizgi.png" style="height:32px;width:2px;padding-top:15px;padding-left:0px;padding-right:0px;"></td>
...
<!-- Slayt haberleri-->
                        <td>
<?php
    $sql2 = "SELECT COUNT(*) as total FROM saglik";
...
?>
                            <script>
                                ...
                                document.getElementById("hbr").href = "haber.php?ktg=saglik&haber=" + imageIndex;
                                document.getElementById("hbr").target = "_blank";

                                }
                                function go(index){
                                  window.location = "haber.php?ktg=saglik&haber=" + index;
                                }
                                function degis(){
                                    ...
                                    <td>
                                        <div>
                                          <?php
                                            ...
                                            echo '<a id="hbr" href="haber.php?ktg=saglik&haber=' . $id . '"><img id="slayt" src="../mboss/saglik/haber' . $id . '.png" width="950px" height="610px"></a>';
                                          ?>
                                        </div>
                                    </td>
                                    <?php
                                ...
                                <tr>
                                    <td>
                                        <?php
                                            ...
                                            $id = $row2['total'];
                                        ?>
                                        <a target="_blank" style="text-decoration:none;" href="haber.php?ktg=saglik&haber=<?php echo $id; ?>"><img src="../mboss/saglik/haber<?php echo $id; ?>.png" style="width:510px;height:205px;"></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <a target="_blank" style="text-decoration:none;" href="haber.php?ktg=saglik&haber=<?php echo $id; ?>">
                                            <div style="text-align:justify;text-decoration:none;width:510px;height:100px;color:black;font-size:20px;padding-bottom:15px;">
                                                <?php
                                                    $sql = "SELECT baslik FROM saglik WHERE resim= '$id'";
                                                    mysqli_set_charset($connection, "utf8");
                    ...
                    <tr>
                        <td>
                            <?php
                                ...
                                $id = $row2['total'] - 2;
                            ?>
                            <a target="_blank" style="text-decoration:none;" href="haber.php?ktg=saglik&haber=<?php echo $id; ?>"><img src="../mboss/saglik/haber<?php echo $id; ?>.png" style="width:250px;height:250px;"></a>
                        </td>
                        <td style="width:10px;">
                        </td>
                        <td>
