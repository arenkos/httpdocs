...
if (strpos($userAgent, 'Mobile') == false) {
    ?><meta http-equiv="refresh" content="0; URL=magazin.php">
    <?php
}
?>
<meta charset="utf-8">
...
?>
                                        ...
                                        document.getElementById("hbr").href = "magazin/haber.php?haber=" + imageIndex;
                                        document.getElementById("hbr").target = "_blank";

                                        }
                                        function go(index){
                                          window.location = "magazin/haber.php?haber=" + index;
                                        }
                                        function degis(){
                                            ...
                                            <td style="width:90%;">
                                                <div>
                                                  <?php
                                                    ...
                                                    echo '<a id="hbr" href="magazin/haber.php?haber=' . $id . '"><img id="slayt" src="../mboss/magazin/haber' . $id . '.png" width="100%" height="310px"></a>';
                                                  ?>
                                                </div>
                                            </td>
                                            <td style="width:5%;">
                                        ...
                                        <tr style="width:100%">
                                            <td style="width:100%">
                                                <?php
                                                    ...
                                                    $id = $row2['total'];
                                                ?>
                                                <a target="_blank" style="text-decoration:none;" href="haber-mobil.php?ktg=magazin&haber=<?php echo $id; ?>"><img src="../mboss/magazin/haber<?php echo $id; ?>.png" style="width:100%;height:205px;"></a>
                                            </td>
                                        </tr>
                                        <tr style="width:100%">
                                            <td style="width:100%">
                                                <a target="_blank" style="text-decoration:none;" href="haber-mobil.php?ktg=magazin&haber=1"><div style="text-align:justify;text-decoration:none;width:100%;height:100px;color:black;font-size:15px;">
                                                    <?php
