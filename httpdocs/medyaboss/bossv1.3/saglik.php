...
if (strpos($userAgent, 'Mobile') == true) {
    ?><meta http-equiv="refresh" content="0; URL=saglik-mobil.php">
    <?php
}
?>
<meta charset="utf-8">
        ...
        <div style="width:100%;height:50px;background:#232323;margin: 0 auto;">
            <table style="width:1540px;height:50px;background:#232323;margin: 0 auto;text-align:justify;">
                <tr>
                    ...
                    <td><img src="cizgi.png" style="height:32px;width:2px;padding-top:15px;padding-left:0px;padding-right:0px;"></td>
                    <td style="width:120px"><a onmouseover="this.style.color='#FFB600';" onmouseout="this.style.color=#FFB600;" style="width:155px;background:#232323;font-size:15px;font-family:Poppins;text-decoration: none;color:#FFB600;" href="saglik.php">Sağlık</a></td>
                    <td><img src="cizgi.png" style="height:32px;width:2px;padding-top:15px;padding-left:0px;padding-right:0px;"></td>
        ...
        <td>
            <div style="padding-top:50px;width:1540px;margin: 0 auto;">
                    ...
                    <tr>
                        ...
                        <td>
                            <script>
                                ...
                                document.getElementById("slayt").src = "../bossv1.8/saglik/haber" + imageIndex + ".webp";
                                document.getElementById("hbr").href = "saglik/haber.php?haber=" + imageIndex;
                                document.getElementById("hbr").target = "_blank";
                                document.getElementById("secim"+imageIndex).src = "dolu.png";

                                }
                                function go(index){
                                  window.location = "saglik/haber.php?haber=" + index;
                                }
                                function degis(){
                                  document.getElementById("secim"+imageIndex).src = "dolu.png";
                                }
                                ...
                                function showImage(imageIndex) {
                                    ...
                                    imageElement.src = "../bossv1.8/saglik/haber" + imageIndex + ".webp";
                            ...
                            <div>
                              <?php
                                ...
                                echo '<a id="hbr" href="saglik/haber.php?haber=' . $selected_image . '"><img id="slayt" src="../bossv1.8/saglik/haber' . $selected_image . '.webp" width="990px" height="610px"></a>';
                              ?>
                            </div>
                        ...
                        <td>
                            <table>
                                <tr>
                                    <td>
                                        <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?haber=1"><img src="../bossv1.8/saglik/haber1.webp" style="width:510px;height:205px;"></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?haber=1">
                                ...
                                <tr>
                                    <td>
                                        <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?haber=2"><img src="../bossv1.8/saglik/haber2.webp" style="width:510px;height:205px;padding-bottom:25px;"></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?haber=2">
                                        <div style="text-align:justify;text-decoration:none;width:510px;height:100px;color:black;font-size:20px;padding-bottom:15px;">
                                            <?php
                ...
                <table style="width:1540px;margin: 0 auto;">
                    <tr>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?haber=3"><img src="../bossv1.8/saglik/haber3.webp" style="width:250px;height:250px;"></a>
                        </td>
                        <td style="width:10px;">
                        </td>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?haber=3">
                                <div style="text-align:justify;text-decoration:none;width:510px;height:100px;color:black;font-size:20px;padding-bottom:15px;">
                                    <?php
                        ...
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?haber=4"><img src="../bossv1.8/saglik/haber4.webp" style="width:250px;height:250px;"></a>
                        </td>
                        <td style="width:10px;">
                        </td>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?haber=4">
                                <div style="text-align:justify;text-decoration:none;width:510px;height:100px;color:black;font-size:20px;padding-bottom:15px;">
                                    <?php
                    ...
                    <tr>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?haber=5"><img src="../bossv1.8/saglik/haber5.webp" style="width:250px;height:250px;"></a>
                        </td>
                        <td style="width:10px;">
                        </td>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?haber=5">
                                <div style="text-align:justify;text-decoration:none;width:510px;height:100px;color:black;font-size:20px;padding-bottom:15px;">
                                    <?php
                        ...
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?haber=6"><img src="../bossv1.8/saglik/haber6.webp" style="width:250px;height:250px;"></a>
                        </td>
                        <td style="width:10px;">
                        </td>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?haber=6">
                                    <div style="text-align:justify;text-decoration:none;width:510px;height:100px;color:black;font-size:20px;padding-bottom:15px;">
                                        <?php
                    ...
                    <tr>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?haber=7"><img src="../bossv1.8/saglik/haber7.webp" style="width:250px;height:250px;"></a>
                        </td>
                        <td style="width:10px;">
                        </td>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?haber=7">
                                <div style="text-align:justify;text-decoration:none;width:510px;height:100px;color:black;font-size:20px;padding-bottom:15px;">
                                    <?php
                        ...
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?haber=8"><img src="../bossv1.8/saglik/haber8.webp" style="width:250px;height:250px;"></a>
                        </td>
                        <td style="width:10px;">
                        </td>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?haber=8">
                                    <div style="text-align:justify;text-decoration:none;width:510px;height:100px;color:black;font-size:20px;padding-bottom:15px;">
                                        <?php
                    ...
                    <tr>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?haber=9"><img src="../bossv1.8/saglik/haber9.webp" style="width:250px;height:250px;"></a>
                        </td>
                        <td style="width:10px;">
                        </td>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?haber=9">
                                <div style="text-align:justify;text-decoration:none;width:510px;height:100px;color:black;font-size:20px;padding-bottom:15px;">
                                    <?php
                        ...
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?haber=10"><img src="../bossv1.8/saglik/haber10.webp" style="width:250px;height:250px;"></a>
                        </td>
                        <td style="width:10px;">
                        </td>
                        <td>
                            <a target="_blank" style="text-decoration:none;" href="saglik/haber.php?haber=10">
                                <div style="text-align:justify;text-decoration:none;width:510px;height:100px;color:black;font-size:20px;padding-bottom:15px;">
                                    <?php
