        ...
        <div style="margin: 0 auto;width:100%;text-align:justify;">
            ...
            <table style="text-align:justify;width:100%;">
                ...
                <tr style="text-align:justify;height:500px;width:100%">
                    <td>
                        <img src="https://www.medyabosshaber.com/bossv1.8/gundem/haber<?php echo $_GET['haber']; ?>-1.webp" style="width:100%;height:500px;padding-top:20px;">
                    </td>
                ...
                <tr>
                    <td>
                        <div>
                            <img src="https://www.medyabosshaber.com/bossv1.8/gundem/haber<?php echo $_GET['haber']; ?>-2.webp" style="width:100%;height:500px;">
                        </div>
                    </td>
                </tr>
                <tr>
