	...
	<main style="text-align:center;padding-top:122px;background-color:#fff;margin: 0 auto;">
		...
		<div style="margin: 0 auto;width:1540px;text-align:justify;">
			<div style="text-align:left;margin-top:300px;">
				<p style="text-align:left;font-family:Poppins;color:#000;"><a href="../ana.php" style="text-decoration:none;color:#000;">Ana Sayfa</a> > <a href="../dunya.php" style="text-decoration:none;color:#000;">Dünya</a> > Rusya’da orman yangını</p>
			</div>
			<table style="text-align:justify;">
				<tr>
					<td style="text-align:left;font-size:50px;font-family:Poppins;width:500px;">
						<p style="text-align:left;"><b>Rusya’da orman yangını</b></p>
					</td>
				...
				<tr>
					<td>
						<div style="padding-top:10px;text-align:justify;width:1000px;height:500px;font-size:20px;font-family:Poppins;">
							Rusya’nın güneybatısında orman yangını çıktı. Rusya Acil Durumlar Bakanlığı (EMERCOM) yangına müdahale anlarına ilişkin görüntüleri yayınladı.Rusya’nın güneybatısındaki Kurgan, Tümen ve Sverdlovsk bölgelerinde orman yangını çıktı.Yangına müdahale için uçaklar ve helikopterler harekete geçti. EMERCOM’dan yapılan açıklamada, “Gün boyunca orman yangınlarıyla mücadelede yaklaşık 6 bin kişi ve 1370 yangın söndürme aracı görev aldı. Serdlovsk bölgesindeki yangınla mücadele sürüyor” denildi.
						</div>
					</td>
				</tr>
				<tr>	
