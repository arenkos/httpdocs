...
if (strpos($userAgent, 'Mobile') == false) {
    ?><meta http-equiv="refresh" content="0; URL=8.php">
    <?php
}
?>
		...
		<div style="margin: 0 auto;width:100%;text-align:justify;">
			...
			<table style="text-align:justify;">
				...
				<tr style="text-align:justify;height:500px;width:100%;">
					<td>
						<img src="../bossv1.4/haber8-1.webp" style="width:100%;height:500px;padding-top:20px;">
					</td>
				</tr>
				<tr>
					<td>
...
Karara yönelik temyiz yolunun açık olduğu kaydedilmişti.
				...
				<tr>	
					<td>
						<div>
							<img src="../bossv1.4/haber8-2.webp" style="width:100%;height:500px;">
						</div>
					</td>
				</tr>
				<tr>	
