	...
	<main style="text-align:center;padding-top:122px;background-color:#fff;margin: 0 auto;">
		...
		<div style="margin: 0 auto;width:1540px;text-align:justify;">
			<div style="text-align:left;margin-top:300px;">
				<p style="text-align:left;font-family:Poppins;color:#000;"><a href="../ana.php" style="text-decoration:none;color:#000;">Ana Sayfa</a> > <a href="../son_dakika.php" style="text-decoration:none;color:#000;">Son Dakika</a> > İran'da dini değerlere hakaret ettikleri gerekçesiyle 2 kişi idam edildi</p>
			</div>
			<table style="text-align:justify;">
				<tr>
					<td style="text-align:left;font-size:50px;font-family:Poppins;width:500px;">
						<p style="text-align:left;"><b>İran'da dini değerlere hakaret ettikleri gerekçesiyle 2 kişi idam edildi</b></p>
					</td>
				...
				<tr style="text-align:justify;height:500px;width:500px;">
					<td>
						<img src="haber14-1.webp" style="width:1000px;height:500px;padding-top:20px;">
					</td>
				...
				<tr>
					<td>
						<div style="padding-top:10px;text-align:justify;width:1000px;height:500px;font-size:20px;font-family:Poppins;">
							İran'da dini değerlerde hakaret ettikleri gerekçesiyle hakkında idam cezası verilen iki kişinin bu sabah infaz edildiği bildirildi. İran'da dini değerlere hakaret ettikleri gerekçesiyle 2 kişi idam edildi.
...
Açıklamada, Zari ve Mihrdad'ın, Hazreti Muhammed'e ve kutsal değerlere hakaret ettikleri, bu konuda onlarca sosyal medya hesabı üzerinden faaliyet yürüttükleri belirtildi.
...
Söz konusu 2 kişi hakkında verilen idam cezalarının bu sabah infaz edildiği aktarıldı.
				...
				<tr>	
					<td>
						<div>
							<img src="haber14-2.webp" style="width:1000px;height:500px;">
						</div>
					</td>
				</tr>
				<tr>	
