	...
	<main style="text-align:center;padding-top:122px;background-color:#fff;margin: 0 auto;">
		...
		<div style="margin: 0 auto;width:1540px;text-align:justify;">
			<div style="text-align:left;margin-top:300px;">
				<p style="text-align:left;font-family:Poppins;color:#000;"><a href="../ana.php" style="text-decoration:none;color:#000;">Ana Sayfa</a> > <a href="../son_dakika.php" style="text-decoration:none;color:#000;">Son Dakika</a> > Hindistan'daki tekne kazasında ölü sayısı 22'ye yükseldi</p>
			</div>
			<table style="text-align:justify;">
				<tr>
					<td style="text-align:left;font-size:50px;font-family:Poppins;width:500px;">
						<p style="text-align:left;"><b>Hindistan'daki tekne kazasında ölü sayısı 22'ye yükseldi</b></p>
					</td>
				...
				<tr>
					<td>
						<div style="padding-top:10px;text-align:justify;width:1000px;height:500px;font-size:20px;font-family:Poppins;">
							Hindistan’da bir teknenin alabora olması sonucu ölü sayısı 16’dan 22’ye yükseldi. Hindistan’ın Kerala eyaletinde yer alan Malappuram’da içerisinde yaklaşık 40 kişinin bulunduğu bir tekne alabora oldu. Yapılan açıklamada, kazada boğularak ölenlerin sayısının 16’dan 22’ye yükseldiği belirtildi. Yetkililer, can kaybının artabileceğini açıkladı. Polis, kaza sonrası kaçan tekne sahibini aradıklarını ifade etti. Bölgede arama-kurtarma çalışmaları devam ediyor. Hindistan Başbakanı Narendra Modi yaptığı açıklamada, hayatını kaybedenlerin yakınlarına başsağlığı dileyerek, ailelere tazminat ödeneceğini açıkladı. Bölge sakinleri, tekne turunun geçen ay başlatıldığını ve güvenlik önlemlerinin bulunmadığını söyledi. 
						</div>
					</td>
				</tr>
				<tr>	
