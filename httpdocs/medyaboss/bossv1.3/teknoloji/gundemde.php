    ...
    <tr>
        ...
        <td>
            <div style="height:100px;">
                <a href="haber.php?haber=1" style="text-decoration:none;color:#000"><img src="https://www.medyabosshaber.com//bossv1.5/teknloji/haber1.webp" style="width:150px;height:100px;"></a>
            </div>
        </td>
        <td>
...
?></a>
    ...
    <tr>
        ...
        <td>
            <div style="height:100px;">
                <a href="haber.php?haber=2" style="text-decoration:none;color:#000"><img src="https://www.medyabosshaber.com//bossv1.5/teknloji/haber2.webp" style="width:150px;height:100px;"></a>
            </div>
        </td>
        <td>
            <div style="background-color:#ededed;text-align:justify;width:220px;height:100px;font-size:15px;font-family:Poppins;padding-left:10px;padding-right:10px;">
...
?></a>
    ...
    <tr>
        ...
        <td>
            <div style="height:100px;">
                <a href="haber.php?haber=3" style="text-decoration:none;color:#000"><img src="https://www.medyabosshaber.com//bossv1.5/teknloji/haber3.webp" style="width:150px;height:100px;"></a>
            </div>
        </td>
        <td>
            <div style="background-color:#ededed;text-align:justify;width:220px;height:100px;font-size:15px;font-family:Poppins;padding-left:10px;padding-right:10px;">
...
?></a>
    ...
    <tr>
        ...
        <td>
            <div style="height:100px;">
                <a href="haber.php?haber=4" style="text-decoration:none;color:#000"><img src="https://www.medyabosshaber.com//bossv1.5/teknloji/haber4.webp" style="width:150px;height:100px;"></a>
            </div>
        </td>
        <td>
            <div style="background-color:#ededed;text-align:justify;width:220px;height:100px;font-size:15px;font-family:Poppins;padding-left:10px;padding-right:10px;">
