	...
	<main style="text-align:center;padding-top:122px;background-color:#fff;margin: 0 auto;">
		...
		<div style="margin: 0 auto;width:1540px;text-align:justify;">
			<div style="text-align:left;margin-top:300px;">
				<p style="text-align:left;font-family:Poppins;color:#000;"><a href="../ana.php" style="text-decoration:none;color:#000;">Ana Sayfa</a> > <a href="../spor.php" style="text-decoration:none;color:#000;">Spor</a> > TFF Başkanı Büyükekşi'den yabancı kuralı açıklaması</p>
			</div>
			<table style="text-align:justify;">
				<tr>
					<td style="text-align:left;font-size:50px;font-family:Poppins;width:500px;">
						<p style="text-align:left;"><b>TFF Başkanı Büyükekşi'den yabancı kuralı açıklaması</b></p>
					</td>
				...
				<tr>
					<td>
						<div style="padding-top:10px;text-align:justify;width:1000px;height:500px;font-size:20px;font-family:Poppins;">
							FF Başkanı Mehmet Büyükekşi, “Seneye Süper Lig'de yabancı kuralı nasıl işlenecek onunla ilgili çalışıyoruz. Önümüzdeki hafta inşallah açıklayacağız. Kulüplerimizde de toplantılar yapıyoruz” dedi. Samsunspor’un şampiyonluk kupasını teslim etmek için Samsun’a gelen Büyükekşi burada açıklamalarda bulundu. Önümüzdeki sezon yabancı kuralı ile ilgili sorulan soruya ise Büyükekşi, “Seneye Süper Lig'de yabancı kuralı nasıl işlenecek onunla ilgili çalışıyoruz. Önümüzdeki hafta inşallah açıklayacağız. Kulüplerimizde de toplantılar yapıyoruz. Yönetim kurulunda karar alıp kamuoyuna açıklayacağız.” ifadelerini kullandı.   
						</div>
					</td>
				</tr>
				<tr>	
