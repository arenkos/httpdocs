	...
	<main style="text-align:center;padding-top:122px;background-color:#fff;margin: 0 auto;">
		...
		<div style="margin: 0 auto;width:1540px;text-align:justify;">
			<div style="text-align:left;margin-top:300px;">
				<p style="text-align:left;font-family:Poppins;color:#000;"><a href="../ana.php" style="text-decoration:none;color:#000;">Ana Sayfa</a> > <a href="../ekonomi.php" style="text-decoration:none;color:#000;">Ekonomi</a> > Cumhurbaşkanı Erdoğan’dan asgari ücret mesajı</p>
			</div>
			<table style="text-align:justify;">
				<tr>
					<td style="text-align:left;font-size:50px;font-family:Poppins;width:500px;">
						<p style="text-align:left;"><b>Cumhurbaşkanı Erdoğan’dan asgari ücret mesajı</b></p>
					</td>
				...
				<tr>
					<td>
						<div style="padding-top:10px;text-align:justify;width:1000px;height:500px;font-size:20px;font-family:Poppins;">
							Cumhurbaşkanı Erdoğan: [Asgari Ücret] Bakanımızın sendikalarla yaptığı görüşmelerin neticesini Salı günü inşallah kamuoyuna açıklayacağım. Bunu açıklayarak inanıyorum ki işçilerimiz de yeni döneme çok farklı girecek. Eskiden 66 lira olan en düşük emekli maaşını 7500 liraya yükselttik. İnşallah 7500 liranın üzerindeki emekli maaşlarını düzeltmek için bir çalışma yapacağız. Asgari ücreti gözden geçireceğiz. Memurlarımızın maaşına Temmuz'da sadece enflasyon farkı eklemekle kalmayıp refah payı artışı da yapacağız. Kamu işçileri için zammını da salı günü açıklayacağız.
						</div>
					</td>
				</tr>
				<tr>	
