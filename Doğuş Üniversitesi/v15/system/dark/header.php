	...
	<table style="height:100%;margin:0 auto;text-align:center;max-width:80%;">
		<tr>
			<td style="height:100%;vertical-align:middle;">
				<img src="../../d.png?v=<?php echo time(); ?>" style="height:50px;width:auto;">
			</td>
			<td style="height:100%;margin:0 auto;text-align:center;vertical-align:middle;">
				<p style="font-size:20px;color:#FFFFFF;width:auto;margin:0 auto;vertical-align:middle;">Doğuş Üniversitesi</p>
			</td>
		</tr>
	</table>
            ...
            <tr>
                <td style="text-align:left;">
                    <label style="color:#151515;">
                        <input type="radio" name="theme" value="dark" onclick="theme_switch('dark')" checked>Koyu
                    </label>
                </td>
                </tr>
                <tr>
                <td colspan="2" style="text-align:left;">
                    <label style="color:#FFFFFF;">
                        <input type="radio" name="theme" value="light" onclick="theme_switch('light')">Açık
                    </label>
                </td>
            </tr>
        </table>
