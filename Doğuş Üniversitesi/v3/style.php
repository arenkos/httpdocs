...
#login-body{
	margin:0 auto;
	background-image:linear-gradient(rgba(255, 255, 255, 0.5), rgba(255, 255, 255, 0.5)),url('back.png?v=<?php echo tim(); ?>');
...
.logo-panel #logo{
	...
	justify-content: center;
	align-items: center;
	background-image:url('d.png?v=<?php echo tim(); ?>');
...
.down-panel {
	...
	justify-content: center;
	align-items: center;
	background-image:url('b.png?v=<?php echo tim(); ?>');
	background-size:100% 100%;
	width: 250px;
	height: 15%;
	margin: 0 auto;
...
.main #top {
	...
	background-image: linear-gradient(rgba(220, 50, 50, 0.75), rgba(220, 50, 50, 0.75)),url('bg.png?v=<?php echo tim(); ?>');
